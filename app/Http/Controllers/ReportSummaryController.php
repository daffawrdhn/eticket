...
class ReportSummaryController extends BaseController
{
    ...
    public function getDataSumary(Request $request, $id){
        try {
            ...
            if ($id == 0) {
                ...
                if ($request->regional_id == 0) {
                    ...
                    $regionals = Regional::where('regional_id', $request->regional_id)->get();
                    ...
                    $regionals = Regional::where('regional_id', $id)->get();

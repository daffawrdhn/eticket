...
@section('container')
    <div class="container-fluid">
        <div class="container-fluid col-lg-4 col-md-6 col-sm-12 p-2 position-absolute top-50 start-50 translate-middle">
                <div id="bg-blue" class="col-lg-12 col-md-12 col-sm-12 p-3 rounded">
                    ...
                    <form id="form-login" action="" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" class="form-control rounded-pill ps-4" id="password" name="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required>

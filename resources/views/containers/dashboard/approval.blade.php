...
@section('container')
            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active">Approval>>Regional PIC</li>
                    </ol>
                    ...
                    <div class="container-fluid p-4 rounded shadow position-relative">
                        ...
                        <div class="container-fluid" id="overflow">    
                            ...
                            <div class="tooltipButtonAdd">
                                ...
                                <p class="tooltiptext">Add Regional PIC</p>
                            </div>
    ...
    <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog" id="dialog-modal">
            ...
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="staticBackdropLabel">Add New Approval Regional PIC</h1>
    ...
    <script src="{{ asset('action/approval/approval.js') }}"></script>
@endsection
